...
export const Route = createFileRoute("/_auth/dashboard/runs/")({
  component: RunsPage,
})
...
function RunsPage() {
  ...
  const runs = useAgentRuns(currentProjectId, {
    from,
    limit: PAGE_SIZE,
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <RunsChart projectId={currentProjectId} from={from} bucket={bucket} />
